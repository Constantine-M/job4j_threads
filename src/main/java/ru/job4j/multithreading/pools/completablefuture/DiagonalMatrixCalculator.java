...
/**
 * Данный класс описывает решение задачи
 * и демонстрирует возможности
 * асинхронного кода.
 *
 * <p>Пусть нам нужно посчитать суммы
 * элементов по диагоналям матрицы.
 * Сколько диагоналей в матрице? 2 * N.
 */
public class DiagonalMatrixCalculator {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        int[] result = DiagonalMatrixCalculator.asyncSum(matrix);
